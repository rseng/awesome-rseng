...
If you want to get involved with science and research software engineering, this is a good place to start! If you want to use the GitHub action, [see rseng/good-first-issues](https://github.com/rseng/good-first-issues).
